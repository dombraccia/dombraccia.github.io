...
date: 2024-07-21
tags: [Python, R, data, bioinformatics, tutorial]
draft: false
---
...
[^1]: [Bioinformatics Market Size, Share & Trends Analysis Report](https://www.grandviewresearch.com/industry-analysis/bioinformatics-industry)

# Quick Start

> **Attention Windows Users**: This tutorial is tailored towards MacOS and Linux OS. For dedicated Windows users, I recommend this [blog post](https://medium.com/@larysha.rothmann/getting-started-with-wsl-for-bioinformatics-setting-up-a-fully-functional-and-pretty-53b9c79b5380) by Larysha Rothmann.

1. Install [VSCode](https://code.visualstudio.com/download) and relevant extensions:
    - R
    - Python
    - Quarto

2. Install [Quarto](https://quarto.org/docs/get-started/) for creating rich text documents.

3. Download [miniforge](https://github.com/conda-forge/miniforge#Download) for creating stable and reproducible coding environments.
...
4. Clone the [bioinfo-2024](https://github.com/dombraccia/bioinfo-2024.git) repository.
...
5. Create a stable coding environment with [mamba](https://mamba.readthedocs.io/en/latest/user_guide/mamba.html#mamba).
...
I use [VSCode](https://code.visualstudio.com/) for almost all of my coding tasks. With extensions for Git, Jupyter, Docker, Remote-SSH, and linters for R, Python, Julia, and almost any coding language you can imagine, it is an extremely versatile IDE.[^3]

[^3]: Alternatives to VSCode include: [Rstudio](https://www.rstudio.com/products/rstudio/download/), [Jupyter Lab](https://jupyter.org/install), and [PyCharm](https://www.jetbrains.com/pycharm/download/). Ultimately, your choice of IDE essentially comes down to personal preference, so don't spend too much time thinking about it.
...
We will now work out of a repo set up with a minimal example of a bioinformatics analysis project. This next part required that you have Git downloaded, so if you don't have it yet, you can download it [here](https://git-scm.com/downloads).
...
Learn more about customizing yml files [here](https://mamba.readthedocs.io/en/latest/user_guide/mamba.html#yml-files).
